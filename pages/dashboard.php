          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="login.php" class="nav-link text-black font-weight-bold px-0">
                ...
                <span class="" style="color:#000" href>Cerrar Sesión</span>
              </a>
            </li>
                  ...
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1" style="color:#000">
                          <span class="font-weight-bold" style="color:#000">Reporte de ventas</span>
                          <span style="color:#000"> de Semana 1</span>
                        </h6>
                        <p class="text-xs text-secondary mb-0" style="color:#000">
                          <i class="fa fa-clock me-1" style="color:#444444"></i>
                          Hace 1 día
                        </p>
                      </div>
                    </div>
                  ...
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1" style="color:#000">
                          <span class="font-weight-bold" style="color:#000">Reporte de Ventas</span>
                          <span style="color:#000"> del mes de Septiembre </span>
                        </h6>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Inventario</p>
                    <h5 class="font-weight-bolder">
                      +3,462
                    </h5>
                    <p class="mb-0">
