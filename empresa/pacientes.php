  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <!-- End Navbar -->
            ...
            <div class="container mt-2">
               ...
               <button class="btn btn-dark" type="button" data-bs-toggle="collapse" data-bs-target="#paciente" aria-expanded="false" aria-controls="formularioCollapse" style="background-color: black; color: white;">
    ...
    <style>
    .divider {
      border-bottom: 1px solid black; /* Cambia el color de la línea y el grosor según lo necesites */
...
<div class="col-md-3 position-relative">
    ...
    <input type="text" class="form-control" id="validationTooltip02" value="Al poner la fecha de nac. se agregue la edad" required>
    <div class="valid-tooltip">
