    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8 mx-auto text-center mb-4 mt-2">
          <a href="https://www.facebook.com/Lotticaa/?show_switched_toast=0&show_invite_to_follow=0&show_switched_tooltip=0&show_podcast_settings=0&show_community_review_changes=0&show_community_rollback=0&show_follower_visibility_disclosure=0" target="_blank" class="text-secondary me-xl-4 me-4">
			<i class="fab fa-facebook"></i>
          </a>
          <a href="https://www.instagram.com/lott.ica?igsh=MWc1M3NsNnIyNTB0ZA==" target="_blank" class="text-secondary me-xl-4 me-4">
		    <i class="fa fa-instagram" aria-hidden="true"></i>
          </a>
          <a href="https://www.tiktok.com/@lottica123?_t=8jgl554p50f&_r=1" target="_blank" class="text-secondary me-xl-4 me-4">
